...
/**
 * DemoApp
 * Program shows an unorganised list and then a list that has been organised by the insertion sort algorithm
 */
public class DemoApp {
    public static void main(String[] args) throws Exception {
        ...
        int[] numbersArraySorted=InsertionSort.sort(numbersArray);
